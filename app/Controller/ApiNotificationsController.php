 ...
 */
	public function index() {
		...
		if (!isset($this->api_website_id)) {
			...
			$website_id = $this->api_website_id; // TODO: get website_id by APIKey

			$options = array('conditions' =>
				array('notifications.website_id !=' => $website_id));
 ...
 */
	public function view($id = null) {
		...
		$options = array('conditions' =>
			array('notifications.' . $this->ApiNotification->primaryKey => $id));
 ...
 */
	public function add() {
		...
		if ($this->request->is('post')) {
			...
			$apiNotification = $this->ApiNotification->find('first',
